...
declare type PerformerFn = CreatorFn['performers'][number];
...
export declare type AnimationOptions = Omit<UserAnimationOptions, 'loop' | 'dur' | 'delay' | 'endDelay' | 'originalAnimationOptions'> & {
