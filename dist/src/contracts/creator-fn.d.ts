...
import { AnimationOptions, AnimationInstance, UserAnimationOptions } from './animation-inter';
...
export interface CreatorFnMethods {
     ...
     * The call-back
     */
    on(eventName: ListenersEventsName, callbackfn: (this: PerformerFn, item: unknown, performerFn: PerformerFn) => true | void | undefined | false): this;
    on(eventName: string, callbackfn: (this: PerformerFn, item: unknown, performerFn: PerformerFn) => true | void | undefined | false): this;
    on(eventName: AllAnimableProperties, callbackfn: (this: PerformerFn, item: unknown, performerFn: PerformerFn) => true | void | undefined | false): this;
    /**
    ...
    set(propertyName: AllAnimableProperties, propertyValue: ValuesToAnimateProperty): this;
...
export interface CreatorFnProperties {
    ...
    global: {
         ...
         */
        newSpecialProperty(property: string, callbackfn?: CreateSpecialPropertyCallbackfn): CreatorFn['global'];
        /**
         ...
         */
        newSpecialProperty(properties: Record<string, CreateSpecialPropertyCallbackfn>): CreatorFn['global'];
        /**
         ...
         * The function responsible for the property.
         */
        newObservedProperty(property: string, callbackfn?: CreateObserverPropertyCallbackfn): CreatorFn['global'];
        /**
         ...
         * An object containing the name of the new properties pointing to the function responsible for the property.
         */
        newObservedProperty(properties: Record<string, CreateObserverPropertyCallbackfn>): CreatorFn['global'];
        /**
 ...
 */
declare type CreatorFn = CreatorFnProperties & CreatorFnMethods & {
    (): CreatorFn['global'];
