...
export default function flattenKeyframes(keyframes: Keyframes | PropertiesToAnimateObject, duration: number, propertiesUsed: PerformerFnProperties['propertiesUsed']): PropertiesToAnimateObjectKeyframes;
