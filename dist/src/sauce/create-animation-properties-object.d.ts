...
export default function createAnimationPropertiesObject(animationPerformer: PerformerFn, animate: PropertiesToAnimateObject | Keyframes | AllAnimableProperties | ValuesToAnimateProperty[], parametersToAnimateOrPropertyValue?: AnimationOptions | ValuesToAnimateProperty | ValuesToAnimateProperty[] | true, parametersToAnimateOrDurOrAutoDestroy?: AnimationOptions | AnimationOptions['dur'] | true): AnimationOptions;
